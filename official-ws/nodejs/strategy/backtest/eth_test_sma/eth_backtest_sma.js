...
const BackTestSma = require('../test_sma/BackTestSma')
...
var candles = require('../data/teth5m')
...
manager.addNewStrategy(new BackTestSma({
  ...
  '5m': { smaFastLen: 44, smaSlowLen: 80 },
  // '5m': { smaFastLen: 40, smaSlowLen: 88 },
  disableLong: false,
  disableShort: true,
  longRateLen: -1,
  longPriceRateMin: 0.9,
  longPriceRateMax: 1,
  shortRateLen: 200,
...
function testRange(indexRange) {
  ...
  manager.setCandleHistory('5m', candles.slice(startIndex - 380, startIndex))
