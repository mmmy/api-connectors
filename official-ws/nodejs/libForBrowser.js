...
var DeltaParser = {
  ...
  onAction(action, tableName, symbol, client, data) {
    ...
    if (action === 'partial') return DeltaParser._partial(tableName, symbol, client, data);
    ...
    return DeltaParser['_' + action](client._data[tableName], symbol, data.data, client._keys[tableName]);
  },
